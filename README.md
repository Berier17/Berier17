...
| **[🏛️ Abu Dhabi Museum Analytics](https://github.com/Berier17/Guggenheim-Abu-Dhabi-Museum-Dashboard)** | **Enterprise BI Dashboard:** Designed a dashboard to monitor and optimize the document control and engineering drawing workflows for the Guggenheim Abu Dhabi construction project. | `Power BI` `DAX` `Power Query` `SQL` |
